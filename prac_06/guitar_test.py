...
def main():
    ...
    print(f"{guitar_1.name} get_age() - Expected {CURRENT_YEAR - guitar_1.year}. Got {guitar_1.get_age(CURRENT_YEAR)}")
    print(f"{guitar_2.name} get_age() - Expected {CURRENT_YEAR - guitar_2.year}. Got {guitar_2.get_age(CURRENT_YEAR)}")
